...
export default function Community() {
  return (
    <>
      <Head>
        <title>ZedSats — Bitcoin Community Zambia | ZamPOS</title>
        <meta name="description" content="Join ZedSats — Zambia's Bitcoin community. Merchants, developers, and Bitcoin enthusiasts building the Lightning economy together with ZamPOS." />
        <meta name="keywords" content="ZedSats, BitDevs Zambia, Bitcoin Zambia, Lightning Network, ZamPOS, Bitcoin Community" />
        <meta property="og:title" content="ZedSats — Bitcoin Community Zambia" />
        <meta property="og:description" content="Join Zambia's Bitcoin community. Merchants, developers, and enthusiasts building the Lightning economy." />
      ...
      <section style={{ 
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1 }}>
          <div style={{ 
            ...
            <span style={{ fontSize: 12, fontFamily: 'var(--font-mono)', color: 'var(--orange)', letterSpacing: '0.06em' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 16 }}>
            {[
              { 
                icon: '✈️', 
                name: 'Telegram', 
                desc: 'Real-time chat with the ZedSats community. News, tips, and support.', 
                cta: 'Join Telegram', 
                href: 'https://t.me/ZedSats',
                active: true 
              },
              { 
                icon: '🐦', 
                name: 'Twitter / X', 
                desc: 'Follow @ZedSats for updates, announcements, and Bitcoin news from Zambia.', 
                cta: 'Follow @ZedSats', 
                href: 'https://x.com/ZedSats',
                active: true 
              },
              { 
                icon: '💬', 
                name: 'WhatsApp Community', 
                desc: 'Connect with Zambian merchants and get help getting started.', 
                cta: 'Coming Soon', 
                href: '#',
                active: false 
              },
              ...
              >
                ...
                <div>
                  <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 17, color: 'var(--black)', marginBottom: 6 }}>
                    {c.name}
                  </h3>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 12 }}>
            {[
              ...
              >
                ...
                <p style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 14, color: 'var(--black)', marginBottom: 4 }}>
                  {w.label}
                </p>
